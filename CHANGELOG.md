...
## [0.12.0](https://github.com/smec-ethz/tatva/compare/v0.11.2...v0.12.0) (2026-07-07)


### Features

* add operator total lagrangian for nonlinear (unclear if change is sufficient) ([2c20645](https://github.com/smec-ethz/tatva/commit/2c20645a89a8080e3877c3af67402fcbae750ca6))
* add quadratic Tri6 element ([37cf37a](https://github.com/smec-ethz/tatva/commit/37cf37a1c9995fa3eeb33ed59523ef017d1e5743))
* add rectangle mesh ([440ad7f](https://github.com/smec-ethz/tatva/commit/440ad7f624d7a2ffaa19050499c8298ae6337a22))
...
* **compound:** add __add__ +rename _data to arr (the flat data array) ([c1e80db](https://github.com/smec-ethz/tatva/commit/c1e80db6cb26d6c9213f25cdd4cf1c02f9c7e943))
...
* **compound:** add .idx for indexing global with local idx +add pytree methods for jax.laxwhile use ([ff4f318](https://github.com/smec-ethz/tatva/commit/ff4f318daee639012e88dc9bdeed13a219879725))
...
* **compound:** add compound class to simplify packing/unpacking from and into flat array ([029cce3](https://github.com/smec-ethz/tatva/commit/029cce3cfc537a8a54d4941a4a1cdb3984a7d45b))
* **compound:** add functionality to reorder the array by stacking fields (make hessian diagonal -&gt; easy sparsity pattern) ([6ce6f49](https://github.com/smec-ethz/tatva/commit/6ce6f492a74ebab985bcb0519e90059bd6b6023d))
...
* **element:** add tetrahedron and hexahedron elements ([5fb66a2](https://github.com/smec-ethz/tatva/commit/5fb66a2f5e3f53272e4da7eaa1c502a2381df744))
* **element:** add tetrahedron and hexahedron elements ([d92b934](https://github.com/smec-ethz/tatva/commit/d92b934cfce2e2d07f0d1dd0158be8b348cbbff4))
...
* **mesh:** add dimension arg ([f730de8](https://github.com/smec-ethz/tatva/commit/f730de83307f0b15dd63a94b55520fb9db583599))
* **mesh:** add generation of quad mesh in 2d ([d09036a](https://github.com/smec-ethz/tatva/commit/d09036a419fc3d8f6b27318736d7123551f97fc5))
...
* **operator:** add map_over_element which maps a generic function over all elements but not gauss points ([1ffd67c](https://github.com/smec-ethz/tatva/commit/1ffd67cad0e5fe3f026250f94d5ad80a8bcc7fb2))
* **operator:** add to map an argument "element_quantity" to specify arguments which are not nodal but elemental values ([5f0e3d6](https://github.com/smec-ethz/tatva/commit/5f0e3d6e1131d1c0aa0145988b853895696bcfd2))
* **operator:** map method ([0a8f94c](https://github.com/smec-ethz/tatva/commit/0a8f94cba1a753f48a5fa82d0ef67c8f53afaa65))
* **operator:** map method to map over any function (provided by the element) given a certain signature ([62deb78](https://github.com/smec-ethz/tatva/commit/62deb78a0aa5339cf4fa4571e4c8129c123eb8ea))
* **operator:** mesh and element validation in __post_init__ ([0978269](https://github.com/smec-ethz/tatva/commit/09782694d6749294b594b6a2e7c20503f1eb7ef6))
* overload integrate function to integrate function, nodal_values, or quad_values +type annotations for optional arguments of decorated functions ([8fbdf15](https://github.com/smec-ethz/tatva/commit/8fbdf15cfa949de8b9560f7cefd21e7acab5079b))
* replace additional_values_at_quad (jax.Array) with a generic *args to pass something additional (like material properties) ([7de0834](https://github.com/smec-ethz/tatva/commit/7de083460d9de92dc2e091ab1613ebb3703c38ef))
* replace additional_values_at_quad (jax.Array) with a generic *args to... ([738a4a5](https://github.com/smec-ethz/tatva/commit/738a4a5dc71e18c9a77d2416bdabf7a27c9049e4))
...
* changes to sparsity pattern generation. need diagonal for LM, for lifting inactive multipliers ([b353c2b](https://github.com/smec-ethz/tatva/commit/b353c2baa332da71bf964bc80e490e91225d238f))
...
* fix cherrypick of interpolate function ([fb0501f](https://github.com/smec-ethz/tatva/commit/fb0501f345658d4225f93b8236f378edda6883b8))
...
* fix total lagrangian for updated lagrangian ([63ded30](https://github.com/smec-ethz/tatva/commit/63ded309db0cb4be41d5e07331845378eded609c))
* fixes after rebase ([3cf2df8](https://github.com/smec-ethz/tatva/commit/3cf2df8f6351470d1646256c2087dfc9c405a83a))
* integrate should only sum over elements and quad points, not dimensions of quantity ([8e20ee4](https://github.com/smec-ethz/tatva/commit/8e20ee4a387030685895d6e361d5eb43a4e138ba))
...
* **mesh:** add correctly the element type and dim arguments also to rectangle() ([42d8951](https://github.com/smec-ethz/tatva/commit/42d8951b18d93d277a55ff88632741481d75dad6))
...
* **operator:** computes detJ with quad weights at initialization ([e40b699](https://github.com/smec-ethz/tatva/commit/e40b699f2f46d5cc1a90acedcb0bca5d8b067be4))
* **operator:** fixes one axis too much in summing integral ([22e5c2c](https://github.com/smec-ethz/tatva/commit/22e5c2cfa71d82093bff48ff880a4f021f152488))
...
* **operator:** moving detJ and detJ weight calculation to initalization ([dc0b03d](https://github.com/smec-ethz/tatva/commit/dc0b03df68c5e8709a77b230da2ca2fd5d110bb3))
...
* **plotting:** add import check and verbose error if optional package matplotlib is missing ([035ea71](https://github.com/smec-ethz/tatva/commit/035ea719d92c4bafb081006becfbd6c495c8a6af))
* **plotting:** remove personal config + bring simple plot methods up to date ([064cda9](https://github.com/smec-ethz/tatva/commit/064cda908893128571531f1b0d8d66c2adc9b6d3))
* **plotting:** removes imports of cmcrameri ([32694c1](https://github.com/smec-ethz/tatva/commit/32694c12e005a841dff93f2876e157e7ceb87003))
* remove autovmap and replacing it with dependency of the original project ([1cb17aa](https://github.com/smec-ethz/tatva/commit/1cb17aa39c1b1b387e7e909d2161b40610d309bf))
...
* update version of jax to &gt;=0.4.1 ([fc6a34d](https://github.com/smec-ethz/tatva/commit/fc6a34d8d8d04f8c2bd1634887c550602f09e628))
...
* **compound:** update docstring of compound class ([0c8fa69](https://github.com/smec-ethz/tatva/commit/0c8fa699f8f0e96f7564d3788f47c438c698734c))
...
* **readme:** bring readme up to date ([6ce6d2c](https://github.com/smec-ethz/tatva/commit/6ce6d2c394386133678fb6fe57656b2694d81b70))
